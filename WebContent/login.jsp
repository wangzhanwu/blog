...
<html>
	<head>
		...
		<title>登录界面</title>
		<link rel="stylesheet" href="${contextPath }/static/css/reset.css" />
	...
	<body>
		...
		<script type="text/javascript" src="${contextPath }/static/js/input.js"></script>
